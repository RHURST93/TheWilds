...
import Header from "../components/header.js";  // Make sure this matches your file name
...
const Calendars = () => {
  return (
    <>
      <Header />
      <h1 className="bg-zinc-950 text-center text-white p-6 text-3xl">Calendars</h1>
      <div className="p-6 bg-zinc-950 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {calendarPhotos.map((photo) => (
          <Link className="card bg-base-100 shadow-xl flex flex-col" key={photo.id} to={photo.link}>
